...
public class BuildingConstructorController implements Initializable {
    ...
    public void PayButtonAction(ActionEvent event) throws IOException {
        ...
        if (twoLevelComfirm == 1){
            WarningLabel.setText("The Price Of This Build Will Be ");
            ...
            if (constructionPrice <= character.getMoney()){
                ...
                if (buildingCategory.equals("Company") ){
                    ...
                    DataBaseOperations.Update( "area" , "Category" , "Company" , area.getID());
                    ...
                    Company company = new Company("Recruitmentaion" , area.getID(), false , BuildingTitleTextField.getText(), "Description goes here",
                            BuildingProductTextField.getText(), price , productPrice  , area.getOwnerID(), 1000 );
